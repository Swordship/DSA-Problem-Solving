...
The cost to him for printing each newspaper is Rs. c. He pays a fixed cost of Rs.100 per Saturday 
for storage, delivery, and so on. He wants to calculate the profit which it obtains only on Saturdays. 
...
public class TheNewspaperAgency {
    ...
    public static void main(String[] args) {
        ...
        int result = ((cop*cos)-(cop*per))-100;
